...
export const GRANDEUR_V1: CarouselStyle = {
  ...
  basePrompt: [
    ...
    '- CRITICAL TYPOGRAPHY & TEXT-INTEGRATION: treat every line of text as a physical, three-dimensional, high-end cinematic element — never a flat digital overlay. Font family & structure: use heavyweight, intentional display fonts (chiseled serifs, heavy architectural types, or epic cinematic fonts) that match the mood of the scene; avoid generic, clean, or rounded digital fonts that look out of place. Textures & materiality: letter surfaces must show tactile physical details — metallic grain, stone grit, micro-scratches, or weathering — matching the environment. 3D depth & extrusion: use thick, deeply extruded 3D bevels (e.g. a rough stone face wrapped in a thick, polished gold bevel) so the text has real weight and volume — never untextured smooth CGI lettering. Unified color harmony: keep a cohesive color and material palette across all lines of text; do not introduce clashing bright neon digital colors or random multi-colored lines unless the creator explicitly marked words for highlight. Lighting & shadows: environmental lighting must react with the text — top edges catch highlights and rim light from the scene light source, and heavy ambient occlusion shadows must drop deeply beneath and behind the letters to ground them in the environment so they never look floating, pasted on, or like a digital overlay. Layout, spacing & kerning: tight cohesive line spacing (leading) so the text block reads as a unified architectural structure; precise character spacing (kerning) so letters lock together naturally. Do NOT invent extra promotional text, badges, or benefit pills — only render the requested text. Do NOT allow the text to cover the hero\'s face.',
  ...
  negativeCues:
    'Avoid: inventing extra promotional text, badges, or benefit pills (no "100% FREE", "Beginner to Advanced", side labels, or any wording not provided by the creator) — only render the requested text; text covering the hero\'s face; flat digital fonts; untextured / smooth CGI text; floating or pasted-on letters without heavy ambient occlusion; mismatched lighting on text or face; floating heads; oversized pasted-on head; distorted facial features; removing secondary characters / co-stars / props that belong in the poster composition; copying the subject photo\'s casual hairstyle, beard, expression or outfit instead of the poster\'s styling; using the movie poster actor\'s face for the male lead; blending two faces; extra fingers; misspelled / duplicated / garbled words; placeholder text; unreadable glyphs; watermarks; third-party brand logos; low-resolution textures.',
};
